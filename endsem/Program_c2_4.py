...
while True:
    ...
    valid_moves = np.append(np.linspace(st_cor - 2, st_cor + 2, 5), np.linspace(st_cor - 20, st_cor + 20, 5))
    # array for moves with step = +-2
    risk_moves = np.append(np.linspace(st_cor - 2, st_cor + 2, 3), np.linspace(st_cor - 20, st_cor + 20, 3))

...
sum = int(the_number[0]) + int(the_number[1]) + int(the_number[2]) + int(the_number[3]) + int(the_number[4]) # Adding the digits
print(f'The sum of the individual digits of given number is {sum}') # Printing the sum
